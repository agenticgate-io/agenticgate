 ...
 * transcript.ts
 *
 * Deterministic demo-transcript generator for AgenticGate.
 *
 ...
 *
 * Usage:
 *   DEMO_MODE=true npm run demo:transcript --workspace @agenticgate/agent-client
 *
 * Output:
...
function toText(t: Transcript): string {
  ...
  const lines = [
    bar,
    `  AGENTICGATE DEMO TRANSCRIPT  [${t.label}]`,
    bar,
...
async function main(): Promise<void> {
  console.log("▶ AgenticGate transcript generator  [DEMO_MODE=true]");
