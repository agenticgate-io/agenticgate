...
import type { ProviderDefinition } from "@agenticgate/shared";
      ...
      <div className="lpx-wrap lift-in">
        <header className="lpx-topbar">
          <div className="lpx-brand">
            <img src="/assets/agenticgate-logo.svg" alt="AgenticGate logo" />
            <div>
              <p>AgenticGate</p>
        ...
        <section className="lpx-hero">
          ...
          <p>
            AgenticGate turns internet actions into priced, payable intents. Search, news, and scraping
          ...
          <div className="lpx-hero-glow">
            <img src="/assets/agenticgate-logo.svg" alt="AgenticGate emblem" />
          </div>
        </section>
        ...
        <section className="lpx-manifesto">
          <article>
            ...
            <p>
              AgenticGate removes fixed-cost bloat and replaces it with granular, verifiable access.
